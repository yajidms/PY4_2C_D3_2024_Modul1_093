...
class LoginController {
  ...
  static final Map<String, Map<String, String>> _users = {
    'admin':  {'password': '123',          'role': 'Ketua Tim',        'teamId': 'team_alpha'},
    'oguri':  {'password': 'cap',          'role': 'Pemilik Catatan',  'teamId': 'team_alpha'},
    'kajido': {'password': 'japanvibes',   'role': 'Anggota',          'teamId': 'team_alpha'},
  };
